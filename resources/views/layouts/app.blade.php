        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    <a href="/" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Inicio</a>
                    <a href="/recetas" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Recetas</a>
                    <a href="/tecnicas" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Técnicas</a>
                    <a href="/conceptos" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Conceptos</a>
                    <a href="/funciones" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Funciones IP</a>
                    <a href="/accesorios" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Accesorios</a>
                    <a href="/comparar" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-colors">Comparar</a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-500 leading-relaxed max-w-md">Manual Maestro de Cocina para Instant Pot.</p>
                </div>
                <div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200 text-center text-xs text-gray-400">Recetario Instant Pot — Manual gratuito de cocina a presión</div>
        </div>
    </footer>
